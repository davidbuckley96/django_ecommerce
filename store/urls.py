...
urlpatterns = [
    ...
    path('teste-product/', views.teste3, name='teste-product'),                         # OK
    path('teste-login/', views.teste4, name='teste-login'),                             # OK
    path('teste-register/', views.teste5, name='teste-register'),                       # OK
    path('teste-cart-empty/', views.teste6, name='teste-cart-empty'),                   # OK
    path('teste-cart-empty-login/', views.teste7, name='teste-cart-empty-login'),       # OK
